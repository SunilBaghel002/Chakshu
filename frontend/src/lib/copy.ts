...
export const MAP_OVERLAY_COPY = {
  ...
  resetBearingTitle: 'Reset North / Heading (N)',
  pitch3dTitle: 'Toggle 3D Perspective (P)',
  pitch2dTitle: 'Switch to 2D Top-Down',
  flyToTitle: 'Fly to AOI',
  toggleLabelsTitle: 'Toggle Layer Annotations',
  headingN: 'N',
  mode3D: '3D',
  mode2D: '2D',
  targetPrefix: 'TARGET:',
