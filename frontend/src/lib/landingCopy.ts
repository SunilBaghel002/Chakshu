...
export const ADMIN_PANEL_COPY = {
  ...
  demoData: 'DEMO DATA',
  demoDataTooltip: 'SEEDED FIXTURE EVENTS · NOT REAL TRAFFIC',
  visitors: 'VISITORS',
  visits: 'VISITS',
  medianDwell: 'MEDIAN DWELL',
  opsRun: 'OPERATIONS RUN',
  ...
  stageB: 'STAGE B',
  console: 'CONSOLE',
  noAdminTitle: 'NO ADMIN CONFIGURED',
  noAdminSub: 'Initialize sovereign administrator credentials using the bootstrap CLI.',
  clearanceRequired: 'CLEARANCE REQUIRED',
  forbiddenAdmin: '403 · ADMIN ROLE REQUIRED',
  authRequired: '401 · AUTHENTICATION REQUIRED',
  forbiddenSub: 'Access to /admin is restricted to sovereign administrators.',
  elevateTitle: 'ELEVATE CURRENT SESSION:',
  elevateCmd: 'python scripts/make_admin.py elevate-latest',
  ...
  exitPaths: 'EXIT PATHS',
  droppedLanding: 'DROPPED AFTER LANDING',
  operationsBreakdown: 'OPERATIONS BREAKDOWN',
  operationsSub: 'Direct telemetry answering "what operations did they perform"',
  noOps: 'NO OPERATIONS RECORDED IN THIS RANGE',
  noVisitors: 'NO VISITORS IN THIS RANGE',
  noVisitorsSub: 'WIDEN THE RANGE OR SHARE THE LINK · /',
  deviceSpread: 'DEVICE SPREAD',
  topLocations: 'TOP LOCATIONS',
  noGeo: 'NO GEO DATA AVAILABLE',
  chart: 'CHART',
  table: 'TABLE',
  ...
  loadMore: 'LOAD MORE VISITORS',
  loadingMore: 'LOADING MORE…',
  rawUaTitle: 'Raw User-Agent (Detail View Only)',
  deviceOs: 'DEVICE / OS',
  browser: 'BROWSER',
  screenDpr: 'SCREEN / DPR',
  referrer: 'REFERRER',
  ipHash: 'IP HASH',
  dwell: 'DWELL',
  errors: 'ERRORS',
  ...
  yes: 'YES',
  no: 'NO',
  loadingDossier: 'LOADING DOSSIER…',
} as const;
